// This is script from main menu and I will try to understand for what it is
// used.
...
BIS.menuCustomModule = {
        ...
        init: function() {
            ...
            // ^ return all descendants that have class = dropdown-vertical
            this.elems.itemsKlm1 = this.elems.dropDown.find('.klm1');
            // ^ return all descendants of dropdown-vertical with class klm1
            this.elems.itemsKlm2innerElems = this.elems.itemsKlm1.find('.dropdown-level_2');
            // ^return all descendants of klm1 with class = dropdown-level_2
            this.elems.itemsKlm2 = this.elems.dropDown.find('.klm2');
            // ^ return all descendants of dropdown-vertical with class klm2
            this.elems.lisDesc = this.elems.dropDown.find('>li');
            // return all direct children of dropdown-vertical
