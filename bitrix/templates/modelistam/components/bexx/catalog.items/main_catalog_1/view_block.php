        ...
        <div class="product-image">
            <?if ($item['DETAIL_PICTURE']):?>
                <a href="<?=$item['DETAIL_PAGE_URL']?>">
                    <?//MM-79 добавлен параметр 'zc'=>1  было 'h'=>170 изменено на 'h'=>257 и возвращено 'zc'=>0?>
                    <img class="product-image__image" alt="<?=$item['NAME']?>" title="<?=$item['NAME']?>" src="<?=MakeImage($item['DETAIL_PICTURE'], array('w'=>257, 'h'=>257, 'zc'=>0, 'q'=>100))?>" />
                </a>
            <?else:?>
                <a href="<?=$item['DETAIL_PAGE_URL']?>">
        ...
        <div class="description">
            ...
            <div class="description__labels">
                ...
                <?elseif(strlen($item['PROPERTY_VALUES']['featured']['VALUE'])):?>
                    <?//if (MakeTimeStamp($item['PROPERTY_VALUES']['featured']['VALUE'])>time()): изменил на StrToTime?>
                    <?if (StrToTime($item['PROPERTY_VALUES']['featured']['VALUE'])>time()):?>
                        ...
                        <?//klm ZN-27?>
                            <div class="description__bottom__right">
                                ...
                                <span id="dyn-product-wishlist-compare-<?=$item['ID']?>">
                                 <?$frame = $this->createFrame('dyn-product-wishlist-compare-'.$item['ID'])->begin('');//PST-9?>
