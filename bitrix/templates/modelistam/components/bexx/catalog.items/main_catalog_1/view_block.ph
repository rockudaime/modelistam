    ...
    <div class="product">
        ...
        <div class="description">
            ...
            <div class="description__left">
                ...
                <div class="product-image">
                    <?if ($item['DETAIL_PICTURE']):?>
                        <a href="<?=$item['DETAIL_PAGE_URL']?>">
                            <?//MM-79 добавлен параметр 'zc'=>1?>
                            <img class="product-image__image" alt="<?=$item['NAME']?>" title="<?=$item['NAME']?>" src="<?=MakeImage($item['DETAIL_PICTURE'], array('w'=>150, 'h'=>100, 'zc'=>1, 'q'=>100))?>" />
                        </a>
                    <?else:?>
                        <a href="<?=$item['DETAIL_PAGE_URL']?>">
                ...
                <div class="product__code">
                    арт <span><?=$item['PROPERTY_VALUES']['CML2_ARTICLE']['VALUE'];?></span>
                </div>
            </div>
            ...
            <div class="description__right">
                ...
                <div class="product-price-wrap">
                    <div class="product-price-block">
                                ...
                                <div class="product-add-basket">
                                    <form method="post" action="" id="product-order-form-<?= $item['ID'] ?>">
                                        ...
                                        <div id="product-order-<?= $item['ID'] ?>">
                                            <a class="butt3 ajax-buy-product" href="<?= $item['ID'] ?>"><span>Купить</span></a>
                                        </div>
                                    </form>
                                </div>
                            <?else:?>
                                <div class="product-add-basket">
                                    ...
                                    <div>
                                        <div>
                                            <a href="#reserv-<?=$item['ID']?>"
                                               id="reserv_link-<?= $item['ID'] ?>"
                                               class="butt3"><span>Резерв</span></a>
                                        </div>
                        ...
                        <?//MM-99?>
                        <?if($item['PROPERTY_VALUES']['ORIGINAL_PARTS']['VALUE']): ?>
                            <a href="<?=$item['DETAIL_PAGE_URL']?>?zapchasti=<?=$item['ID']?>">Оригинальные запчасти</a>
                        <?endif; ?>
                        <?//MM-99?>
                    </div>
                </div>
        ...
        <div class="description__bottom">
            ...
            <div class="description__bottom__right">
                <?//PST-9?>
                <span id="dyn-product-wishlist-compare-<?=$item['ID']?>">
                    <?
                    ...
                    <?if ($arParams['SHOW_COMPARE_LINK']!="N"):?>
                        <div id="product-compare-<?=$item['ID']?>" class="product-compare-block">
                            ...
                            <div class="product-compare-link"><span>к сравнению</span></div>
                        </div>
                    <?endif;?>
                    ...
                    <div id="product-wishlist-<?=$item['ID']?>" class="product-wishlist-block">
                        <a href="#product-wishlist-<?=$item['ID']?>"
                           ...
                           params="do=add2wishlist&id=<?=$offer_id?>">
                            В список желаний</a>
                    </div>
