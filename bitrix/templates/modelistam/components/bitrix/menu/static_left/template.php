...
?>
	...
	<ul class="static-left-menu accordion">
<?
	$previousLevel = 0;
...
?>
		...
		<? else:?>
			...
			<a<?=$bHasSelected ? ' class="opener selected"' : ' class="opener " '?> href="<?=$arItem["LINK"]?>"><?=$arItem["TEXT"]?></a>
			<div class="slide"><ul<?=$bHasSelected || ($bManyIblock && $arItem['DEPTH_LEVEL'] <= 1) ? '' : ' style="display:none;"'?>>
		<? endif?>
