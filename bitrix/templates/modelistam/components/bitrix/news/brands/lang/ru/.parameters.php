...
$MESS ['IBLOCK_ALL_TYPES'] = "Все типы";
$MESS ['IBLOCK_SELECT_ONE'] = "Выберите инфоблок";
$MESS ['SELECT_IBLOCK_TYPE'] = "Тип инфоблока с товарами";
$MESS ['SELECT_IBLOCK_ID'] = "Инфоблок с товарами";
?>
