...
<div class="news-list catalog-news-template">
            ...
            <?if($arParams["DISPLAY_PICTURE"]!="N" && is_array($arItem["PREVIEW_PICTURE"])):?>
                <a class="news_item__img-wrap" href="<?=$arItem["DETAIL_PAGE_URL"]?>">
                    <img class="preview_picture adaptive-img"
                         src="<?=MakeImage($arItem["PREVIEW_PICTURE"]["SRC"], array('wl'=>474, 'hl'=>244, 'q'=>100, 'zc'=>0, 'iar'=>0, 'far'=>"C"))?>"
