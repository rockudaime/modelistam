	...
	<table class="catalog-detail" cellspacing="0">
		...
		<?if (is_array($arResult['DETAIL_PICTURE_350']) || count($arResult["MORE_PHOTO"])>0):?>
			...
			<td class="catalog-detail-image">
				...
				<div class="catalog-detail-image" id="catalog-detail-main-image">
					<img src="/bitrix/templates/store_minimal_violet/images/no-photo-big.gif" width="250" height="250" alt="Фото ожидается" title="Фото ожидается" id="catalog_list_image" />
				</div>
			...
			<?endif;?>
				...
				<?
					...
					<div class="catalog-item-price">
						<span class="catalog-item-price" style="color: red; font-weight: normal;">Нет в наличии</span>
					</div>
					<?$not_av = 1;
					  endif;
				endforeach;
				...
				<?else:?>
				<div class="catalog-detail-buttons">
					<!--noindex--><a href="<?=$arResult["ADD_URL"]?>" rel="nofollow" onclick="return false"><span><?echo GetMessage("CATALOG_ADD_TO_BASKET")?></span></a><!--/noindex-->
				</div>
				<?endif;?>

				<div class="catalog-item-links">
					<?if(!$arResult["CAN_BUY"] && (count($arResult["PRICES"]) > 0) && !$not_av):?>
