    ...
    <?else:?>
        ...
        <form method="post" action="<?=POST_FORM_ACTION_URI?>" name="regform" enctype="multipart/form-data">
            ...
            <div class="registration__title">
                    ...
                    <?else:?>
                        <div class="registration__entity">
                            ...
                            <?
                                ...
                                {
                                    case "PASSWORD":
                                        ?><input size="30" type="password" name="REGISTER[<?=$FIELD?>]" value="<?=$arResult["VALUES"][$FIELD]?>" autocomplete="off" class="bx-auth-input inputtext" />
                ...
                <div style="margin: 20px 0; color: #333333;">Регистрируясь, вы соглашаетесь<br>с <a href="/about/dir_rules/">пользовательским соглашением</a></div>
