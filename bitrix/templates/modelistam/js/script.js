...
/* BIS global Object with all METHODS (populated anywhere) */
if (!window.BIS) {
    window.BIS = {
        debug: true
    }
...
$(function(){
	 ...
	 * href="#some_text" - ��������� �� ���������. #some_text = <div id="some_text"></div>
	 * class="ajax_link" - ������ ������ ����� �������������� ��� AJAX
	 * rel="AJAX_CALL_ID" - md5-���, ������������� AJAX �������
	 * params="IBLOCK_ID=1&TYPE=2" - �������������� � ���������� ��������� ��� AJAX-�������
	 */
	$(".ajax_link").click(function(){ // ��������� ������ AJAX
